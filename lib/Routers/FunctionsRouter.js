        ...
        var _ret = function () {
          ...
          return {
            v: new Promise(function (resolve, reject) {
              ...
              var cleanInput = _logger.logger.cleanAndTruncateLogMessage(JSON.stringify(params));
              var response = FunctionsRouter.createResponseObject(function (result) {
                try {
                  var cleanResult = _logger.logger.cleanAndTruncateLogMessage(JSON.stringify(result.response.result));
